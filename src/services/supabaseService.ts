...
export class SupabaseService {
  ...
  static async fetchInstagramAccount(userId: string): Promise<InstagramAccount | null> {
    ...
    return {
      ...
      followersCount: typeof data.followers_count === 'number' ? data.followers_count : 1,
  ...
  static async saveInstagramAccount(account: InstagramAccount, userId: string): Promise<boolean> {
    ...
    const payload = {
      ...
      followers_count: typeof account.followersCount === 'number' ? account.followersCount : 1,
      media_count: typeof account.mediaCount === 'number' ? account.mediaCount : 0,
